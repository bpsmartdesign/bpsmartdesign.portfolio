...
<body>
	<div id="page">
		...
		<footer>
			...
			<p class="cpy">copyright &copy; 2014 - 2021 Todos los derechos reservados ! por #bpsmartdesign</p>
			<div>
				<form method="post">
	...
	<script>
		...
		chatbox.setAttribute("page_id", "104562031627785");
