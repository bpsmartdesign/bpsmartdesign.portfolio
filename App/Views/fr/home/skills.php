<section class="one">
	<div class="vertical_align">
		<h1>Compétences</h1>
		<p>
			Ayant débuté dans le tas à ma toute jeunesse, passionné du développement en général,
			il a dû se passer près de deux (2) ans afin de pencher définitivement pour le web & tout récement le mobile.
		</p>
		<p>
			Les contributions apportées sur plusieurs projets privés / publics et personnels, dans le domaine du web ou du mobile
			tout ça en gardant à esprit l'aboutissement d'un meilleur résultat avec des meilleures performances tant visuelles
			que fonctionnelles.
		</p>
		<p>
			Peuvent me permettre aujourd'hui de me prétendre Développeur Fullstack, passionné et objectif dont performance et
			très bon résultat sont les mots-clés.
		</p>
	</div>
</section>
<section class="two">
	...
	<div class="skills">
		<div class="up">
			<h1 class="skill-title">Développement Web</h1>
		...
		<div class="down">
			<h1 class="skill-title">Développement Mobile & Divers</h1>
			<div class="all-skills">
				<div class="skill-left">
					<div class="skill">
				...
				<div class="skill-right">
					...
					<div class="skill">
						<span class="txt-value"><span class="tag green">Autres</span> chess.com, Injustice 2, Prototype, ...</span>
						<div class="fill-value-container bottom">
							<div class="fill-value" data-value="91"></div>
						</div>
					</div>
